...
export const PRODUCTS = [
  ...
  },
  {
    ...
    imgExt: "png",
    name: "Sensart Ceramic Dish Set",
    category: "kitchen",
    price: 39.99,
    rating: 4.5,
    reviews: 92,
    short: "4-piece ceramic dish set with a chip-resistant glaze, oven and microwave safe.",
    description:
      "This Sensart ceramic dish set includes four pieces in a matching glaze finish. Each dish is chip-resistant and transitions safely from oven to microwave to dishwasher. The wide, low-sided shape makes them practical for everything from roasting vegetables to serving pasta at the table.",
    features: [
      "4-piece set with matching glaze",
      "Chip-resistant ceramic",
      "Oven, microwave, and dishwasher safe",
      "Wide low-sided shape for roasting and serving",
    ],
    specs: { Pieces: "4-piece set", Material: "Ceramic", "Oven-safe": "Up to 230°C", Care: "Dishwasher-safe" },
  },
];
